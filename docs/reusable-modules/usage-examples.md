...
module "log_analytics" {
  source = "github.com/POps-Rox/terraform-azurerm-log-analytics?ref=v2.1.1"
...
```terraform
module "key_vault" {
  source = "github.com/POps-Rox/terraform-azurerm-key-vault?ref=v11.2.0"
...
```terraform
module "storage" {
  source = "github.com/POps-Rox/terraform-azurerm-storage-account?ref=v12.1.1"
