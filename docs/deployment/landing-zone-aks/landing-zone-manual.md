...
This document provides guidance on how to deploy a [Mission Enclave Landing Zone Starter with Azure Kubernetes Service](https://github.com/POps-Rox/ref-scca-enclave-landing-zone-starter) using manual methods.
